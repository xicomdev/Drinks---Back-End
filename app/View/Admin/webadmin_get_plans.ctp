                    ...
                    <form method="POST" id="add_plan" class="add_plan" class="well" action="<?php echo $this->webroot; ?>admin/add_plan">
                        ...
                        <header class="panel-heading">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" required class="form-control" placeholder="Enter Duration" name="duration" value="">
                            </div>
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" required class="form-control" placeholder="Enter Discount" name="discount" value="">
                            </div>
                            <div class="clearfix"></div>
                            <div class="col-sm-12">
                                <label class="col-sm-12 control-label">Description</label>
                                <input type="text" required class="form-control" placeholder="Enter Description" name="description" value="">
                            </div>
                            <br>
                            <div class="clearfix"></div>
                            <div class="col-sm-12">
